...
async execute(message,args,client) {
    ...
    .setAuthor("Searching...", "https://i.redd.it/y3wduhwn4gd61.jpg")
    .setColor("#F0EAD6")
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setColor("#F0EAD6")
      .setAuthor("Search results!!", "https://i.redd.it/y3wduhwn4gd61.jpg","http://harmonymusic.tk")
      .setFooter("Response with your favorite number","https://i.redd.it/y3wduhwn4gd61.jpg")
